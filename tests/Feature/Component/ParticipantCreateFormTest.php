...
class ParticipantCreateFormTest extends TestCase
{
    ...
    public function firstname_is_required(): void
    {
        ...
        FormTest::field_is_required_string('participant.create', [], 'firstname', 'save');
    }
    ...
    public function lastname_is_required(): void
    {
        ...
        FormTest::field_is_required_string('participant.create', [], 'lastname', 'save');
    }
    ...
    public function birthdate_is_required(): void
    {
        ...
        FormTest::field_is_required_string('participant.create', [], 'birthdate', 'save');
    }
    ...
    public function gender_is_required(): void
    {
        ...
        FormTest::field_is_required_string('participant.create', [], 'gender', 'save');
    }
    ...
    public function school_grade_is_required(): void
    {
        ...
        FormTest::field_is_required_string('participant.create', [], 'school_grade', 'save');
    }
    ...
    public function photos_allowed_is_optional(): void
    {
        ...
        FormTest::field_is_optional_string('participant.create', [], 'photos_allowed', 'save');
    }
    ...
    public function note_is_optional(): void
    {
        ...
        FormTest::field_is_optional_string('participant.create', [], 'note', 'save');
    }
