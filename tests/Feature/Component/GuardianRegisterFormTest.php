...
class GuardianRegisterFormTest extends TestCase
{
    ...
    {
        FormTest::field_is_required_string('auth.register', [], 'firstname', 'register');
    }

    /** @test */
    public function lastname_is_required(): void
    {
        FormTest::field_is_required_string('auth.register', [], 'lastname', 'register');
    }

    /** @test */
    public function street_is_required(): void
    {
        FormTest::field_is_required_string('auth.register', [], 'street', 'register');
    }

    /** @test */
    public function street_number_is_optional(): void
    {
        FormTest::field_is_optional_string('auth.register', [], 'street_number', 'register');
    }

    /** @test */
    public function postcode_is_required(): void
    {
        FormTest::field_is_required_string('auth.register', [], 'postcode', 'register');
    }
    ...
    {
        FormTest::field_is_required_string('auth.register', [], 'city', 'register');
    }

    /** @test */
    public function phone_is_required(): void
    {
        FormTest::field_is_required_string('auth.register', [], 'phone', 'register');
    }

    /** @test */
    public function email_is_required(): void
    {
        FormTest::field_is_required_string('auth.register', [], 'email', 'register');
    }
